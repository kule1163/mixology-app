...
import BlogPhoto from "../../../assets/blogpost1.jpg"
import gsap from "gsap"
import { ScrollTrigger } from "gsap/ScrollTrigger";

const ClasicCosmopolition = () => {
    ...
    return (
        <MainContainer>
            <FirstSectionBox>
                ...
                <Header ref={firstHeaderRef} variant='h2'>The Classic Cosmopolitan with a twist</Header>
...
export default ClasicCosmopolition